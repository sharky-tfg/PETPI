...
<div class="col-lg-4 col-md-6 mb-4">
    <div class="card perro-card-modern h-100 border-0" data-id="<?= $perro->id_perro ?>">
        ...
        <div class="perro-img-wrapper" style="position: relative;">
            <img src="/PETPI/public/uploads/<?= htmlspecialchars($fotoPrincipal) ?>"
                 class="card-img-top"
            ...
            <?php if ($logueado): ?>
                ...
                <?php if ($_SESSION['usuario']['rol'] === 'usuario' && $estado === 'disponible'): ?>
                    ...
                    <?php else: ?>
                        ...
                        <form method="post" action="/PETPI/public/adoptar.php" class="mt-3">
                ...
                <?php if ($_SESSION['usuario']['rol'] === 'admin'): ?>
                    <div class="mt-3 d-flex gap-2">
                        <a href="/PETPI/public/editar_perro.php?id=<?= $perro->id_perro ?>"
                           class="btn btn-edit w-50">
                            ✏ Editar
                        </a>

                        <form method="post"
                              action="/PETPI/public/eliminar_perro.php"
                              class="w-50"
