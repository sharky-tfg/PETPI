...
require_once $_SERVER['DOCUMENT_ROOT'] . '/PETPI/app/core/Database.php';
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <link rel="stylesheet" href="/PETPI/public/css/estilos.css">
...
<nav class="navbar navbar-expand-lg navbar-dark navbar-premium">
  <div class="container-fluid px-5">
    ...
    <a class="navbar-brand d-flex align-items-center gap-3" href="/PETPI/public/index.php">
    ...
    <div class="collapse navbar-collapse justify-content-between mt-4 mt-lg-0" id="navbarPremium">
        ...
        <ul class="navbar-nav mx-auto gap-lg-4 text-center">
            ...
            <li class="nav-item">
                <a class="nav-link nav-link-premium" href="/PETPI/public/index.php">
                    <i class="bi bi-house-door me-1"></i> Inicio
                </a>
            </li>

            <li class="nav-item">
                <a class="nav-link nav-link-premium" href="/PETPI/public/perritos.php">
            ...
            <?php if (!isset($_SESSION['usuario']) || $_SESSION['usuario']['rol'] !== 'admin'): ?>
                <li class="nav-item">
                    <a class="nav-link nav-link-premium" href="/PETPI/public/contacto.php">
                        <i class="bi bi-envelope me-1"></i> Contacto
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link nav-link-premium" href="/PETPI/public/conocenos.php">
            ...
            <?php if (isset($_SESSION['usuario']) && $_SESSION['usuario']['rol'] === 'usuario'): ?>
                <li class="nav-item">
                    <a class="btn btn-adopt-premium ms-lg-3 mt-3 mt-lg-0" href="/PETPI/public/dar_en_adopcion.php">
            ...
            <?php if (isset($_SESSION['usuario']) && $_SESSION['usuario']['rol'] === 'admin'): ?>
                <li class="nav-item">
                    <a class="btn btn-admin-premium ms-lg-3 mt-3 mt-lg-0" href="/PETPI/public/admin_solicitudes.php">
                        <i class="bi bi-clipboard-data me-1"></i> Solicitudes
                    </a>
                </li>
              
                <li class="nav-item">
                    <a class="btn btn-primary ms-lg-3 mt-3 mt-lg-0" href="/PETPI/public/admin/contactos.php">
        ...
        <ul class="navbar-nav align-items-center text-center">
                        ...
                        <div class="dropdown-menu dropdown-menu-end notificaciones-dropdown shadow-lg border-0 rounded-4 p-0" style="width: 350px;">
                            ...
                            <?php if ($total_notificaciones > 0): ?>
                                <div class="dropdown-footer bg-light p-3 text-center rounded-bottom-4 border-top">
                                    <a href="/PETPI/public/mis_solicitudes.php" class="btn btn-primary w-100 py-2">
                ...
                <?php if ($_SESSION['usuario']['rol'] === 'usuario'): ?>
                    <li class="nav-item dropdown ms-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 p-2 mt-2" style="min-width: 240px;">
                            ...
                            <li>
                                <a class="dropdown-item rounded-3 py-3 my-1" href="/PETPI/public/mis_adopciones.php" style="background: linear-gradient(135deg, #f0fdf4, #dcfce7);">
                            ...
                            <li>
                                <a class="dropdown-item text-danger rounded-3 py-2" href="/PETPI/public/logout.php">
                ...
                <?php if ($_SESSION['usuario']['rol'] === 'admin'): ?>
                    <li class="nav-item dropdown ms-2">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end shadow-lg border-0 rounded-4 p-2 mt-2" style="min-width: 200px;">
                            ...
                            <li><hr class="dropdown-divider"></li>
                            <li>
                                <a class="dropdown-item text-danger rounded-3 py-2 text-center" href="/PETPI/public/logout.php">
                                    <i class="bi bi-box-arrow-right me-2"></i> Cerrar sesión
                                </a>
                            </li>
                        </ul>
            ...
            <?php else: ?>
                <li class="nav-item">
                    <a class="btn btn-login-premium mt-3 mt-lg-0" href="/PETPI/public/login.php">
                        <i class="bi bi-box-arrow-in-right me-1"></i> Iniciar sesión
                    </a>
                </li>
                <li class="nav-item ms-2">
                    <a class="btn btn-outline-light mt-3 mt-lg-0" href="/PETPI/public/registro.php">
