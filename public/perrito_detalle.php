...
require_once $_SERVER['DOCUMENT_ROOT'] . '/PETPI/app/views/layout/header.php';
?>
...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-md-6">
            <img src="/PETPI/public/uploads/<?php echo htmlspecialchars($fotoPrincipal); ?>"
                 class="img-fluid rounded w-100"
                 style="height: 400px; object-fit: cover; cursor: pointer;"
                 onclick="abrirZoom(this.src)"
                 onerror="this.src='/PETPI/public/img/perrillono.png'">
            
            <?php if($tieneMasFotos): ?>
                <div class="row mt-2">
                    <?php for($i = 1; $i < count($fotos) && $i < 4; $i++): ?>
                        <div class="col-3">
                            <img src="/PETPI/public/uploads/<?php echo htmlspecialchars($fotos[$i]['nombre_foto']); ?>"
        ...
        <div class="col-md-6">
            ...
            <?php if(isset($_SESSION['usuario']) && $_SESSION['usuario']['rol'] == 'admin'): ?>
                ...
                <div class="row g-2">
                    <div class="col-6">
                        <form method="post" action="/PETPI/public/eliminar_perro.php" onsubmit="return confirm('¿Seguro que quieres eliminar este perro? Se guardará en el historial.');">
                    ...
                    <div class="col-6">
                        <a href="/PETPI/public/editar_perro.php?id=<?php echo $perro->id_perro; ?>" class="btn btn-warning btn-lg w-100">✏️ Editar</a>
                    </div>
                </div>
            ...
            <?php elseif($perro->estado == 'Disponible'): ?>
                ...
                <?php if(!isset($_SESSION['usuario'])): ?>
                    <a href="/PETPI/public/login.php" class="btn btn-primary btn-lg w-100">Inicia sesion para adoptar</a>
                <?php elseif($_SESSION['usuario']['id_usuario'] == $perro->id_usuario): ?>
                    <div class="alert alert-info">Este perro fue publicado por ti</div>
                <?php else: ?>
                    <form method="post" action="/PETPI/public/adoptar.php">
                        <input type="hidden" name="id_perro" value="<?php echo $perro->id_perro; ?>">
            ...
            <?php else: ?>
                <div class="alert alert-success text-center">
                    ...
                    <a href="/PETPI/public/perritos.php" class="btn btn-primary mt-2">Ver otros perritos</a>
                </div>
            <?php endif; ?>
