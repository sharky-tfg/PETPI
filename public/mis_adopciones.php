...
<div class="container py-5">
    ...
    <?php if (empty($adopciones)): ?>
        <div class="text-center py-5">
            ...
            <a href="/PETPI/public/perritos.php" class="btn btn-primary btn-lg px-5 py-3">
                Buscar perritos
            </a>
        </div>
    <?php else: ?>
            ...
            ?>
                <div class="col-md-6 col-lg-4">
                    <div class="card h-100 shadow">
                        <img src="/PETPI/public/uploads/<?php echo htmlspecialchars($adopcion['foto_principal']); ?>" 
                             class="card-img-top" 
                        ...
                        <div class="card-footer bg-white border-0 pb-4">
                            <a href="/PETPI/public/perrito_detalle.php?id=<?php echo $adopcion['id_perro']; ?>" 
