                    ...
                    <div class="card shadow-sm">
                        ...
                        <div id="content-<?php echo $id; ?>" class="card-body" style="display: none;">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <?php if ($num_fotos > 0): ?>
                                        <img src="/PETPI/public/uploads/<?php echo $s['foto_principal']; ?>" 
                                             class="img-fluid rounded mb-2 w-100" 
                                             style="height: 200px; object-fit: cover; cursor: pointer;"
                                             onclick="abrirZoom('/PETPI/public/uploads/<?php echo $s['foto_principal']; ?>')"
                                            ...
                                            <div class="d-flex gap-2 mt-2">
                                                ...
                                                for ($j = 0; $j < $num_fotos; $j++) {
                                                    if ($fotos[$j]['nombre_foto'] != $s['foto_principal'] && $contador < 3) {
                                                        echo '<img src="/PETPI/public/uploads/' . $fotos[$j]['nombre_foto'] . '" 
                                                              class="rounded" 
                                                              style="width: 60px; height: 60px; object-fit: cover; cursor: pointer;"
                                                              onclick="abrirZoom(\'/PETPI/public/uploads/' . $fotos[$j]['nombre_foto'] . '\')"
                                                              onerror="this.src=\'/PETPI/public/img/perrillono.png\'">';
                                                        $contador++;
                                                    }
                                                }
