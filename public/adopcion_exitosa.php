                ...
                <div class="card-body p-4">
                            ...
                            <div class="carousel-inner rounded-3 shadow">
                                ...
                                ?>
                                    <div class="carousel-item <?php echo $primera ? 'active' : ''; ?>">
                                        <img src="/PETPI/public/uploads/<?php echo htmlspecialchars($foto['nombre_foto']); ?>" 
                                             class="d-block w-100" 
                    ...
                    <?php else: ?>
                        <div class="text-center mb-4">
                            <img src="/PETPI/public/img/perrillono.png" 
                    ...
                    <div class="d-flex gap-3 justify-content-center flex-wrap">
                        <a href="/PETPI/public/perritos.php" class="btn btn-primary px-4 py-2 rounded-pill">
                            <i class="bi bi-arrow-left"></i> Seguir viendo
                        </a>
                        
                        <a href="/PETPI/public/mis_adopciones.php" class="btn btn-outline-primary px-4 py-2 rounded-pill">
