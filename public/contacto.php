              ...
              <div class="col-12">
                <div class="form-check">
                  ...
                  <label class="form-check-label" for="acepto">
                    He leído y acepto la <a href="/PETPI/public/legal/privacidad.php" target="_blank">Política de Privacidad</a> y consiento el tratamiento de mis datos para responder a mi consulta.
                  </label>
                </div>
              </div>
